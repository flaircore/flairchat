...
1. Message thread mini view /assets/message_thread_mini_view.png.
2. Mini view user list /assets/mini_view_user_list.png.
3. Mini view message list /assets/mini_view_message_list.png.
4. Minimized chat view /assets/minimized_view.png.
5. Maximized chat view /assets/max_view.png.
